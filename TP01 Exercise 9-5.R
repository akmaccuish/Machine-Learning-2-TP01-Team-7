...
# (d) Apply this model to the training data in order to obtain a predicted class 
#     label for each training observation. Plot the observations, colored according 
...
# (f) Apply this model to the training data in order to obtain a predicted class 
#     label for each training observation. Plot the observations, colored according 
#     to the predicted class labels. The decision boundary should be obviously non-linear. 
#     If it is not, then repeat (a)-(e) until you come up with an example in which
